package jp.seikeidenron.androidtv.ui.background;
...
/**
 * It is a library class that manages background image/resource
 */
public class PicassoBackgroundManager {
    ...
    public final int DEFAULT_BACKGROUND_RES_ID = R.drawable.default_background_img; //R.drawable.default_background;
